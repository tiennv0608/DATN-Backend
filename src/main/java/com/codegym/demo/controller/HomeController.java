...
public class HomeController {
    ...
    private ResponseEntity<?> findJob(@RequestParam(name = "keyword") String keyword, @RequestParam(name = "cat_id") Long cat_id, @RequestParam(name = "city_id") Long city_id,@RequestParam(name = "salary") double salary){
        List<PostResponse> postResponses;
        postResponses = postService.searchJob(keyword, cat_id, city_id, salary);
